...
from tfaip.trainer.scheduler.cosine_decay_params import WarmupCosineDecayParams, WarmupConstantCosineDecayParams, \
    CosineDecayParams
...
DEFAULT_SCHEDULES = [WarmupCosineDecayParams, WarmupConstantCosineDecayParams, CosineDecayParams, Constant,
